...
Class userController Extends baseController {
    ...
    public function captcha(){
        $response = file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6Ld-91kUAAAAAPTdx9yrYqM_NzSo9q9Huf2jaofX&response=".$_POST['g-recaptcha-response']."&remoteip=".$_SERVER['REMOTE_ADDR']);
    }
