...
Class timesalaryModel Extends baseModel {
	protected $table = "time_salary";
    ...
    public function deleteSalary($id){
    	if ($this->getSalary($id)) {
    		return $this->delete($this->table,array('time_salary_id'=>$id));
    	}
    }
    ...
    public function getAllSalaryByWhere($id){
        return $this->query('SELECT * FROM time_salary WHERE time_salary_id != '.$id);
    }
