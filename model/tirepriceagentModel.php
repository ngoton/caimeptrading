...
Class tirepriceagentModel Extends baseModel {
	protected $table = "tire_price_agent";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_price_agent_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_price_agent WHERE tire_price_agent_id != '.$id);
    }
