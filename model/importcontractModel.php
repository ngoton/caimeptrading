...
Class importcontractModel Extends baseModel {
	protected $table = "import_contract";
    ...
    public function deleteImport($id){
    	if ($this->getImport($id)) {
    		return $this->delete($this->table,array('import_contract_id'=>$id));
    	}
    }
    ...
    public function getAllImportByWhere($id){
        return $this->query('SELECT * FROM import_contract WHERE import_contract_id != '.$id);
    }
