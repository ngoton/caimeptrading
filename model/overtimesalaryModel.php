...
Class overtimesalaryModel Extends baseModel {
    ...
    public function deleteSalary($id){
    	if ($this->getSalary($id)) {
    		return $this->delete($this->table,array('overtime_salary_id'=>$id));
    	}
    }
    ...
    public function getAllSalaryByWhere($id){
        return $this->query('SELECT * FROM overtime_salary WHERE overtime_salary_id != '.$id);
    }
